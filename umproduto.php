...
<div class="container">
  <div class="row mx-5">
    ...
    <div class="col" style="justify-content: center; display:flex; flex-direction:column;">
      <h2 class="text-start card-titulo"><?= $nome ?></h2>
      ...
      <button type="button" class="btn btn-primary capa-produto" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="width: 200px;">
        COMPRAR PRODUTO
      </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Irei entrar em contato</button>
            </div>
          </div>
        </div>
      </div>
